"""
Django settings for purple_math_dev_75804 project.
...
ROOT_URLCONF = 'purple_math_dev_75804.urls'
...
WSGI_APPLICATION = 'purple_math_dev_75804.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "purple_math_dev_75804 API",
    "DESCRIPTION": "API documentation for purple_math_dev_75804 App",
    "VERSION": "v1",
}
